  ...
  >
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
      ...
      <div className="side1 flex flex-col gap-[24px] text-left items-start">
        <img className="w-[150px] lg:w-[173px]" src={FooterLogo} alt="pageLogo" />

        <p className="text-white text-[14px] lg:text-[16px] leading-[22px]">
          Kınacı Qrup tikinti və daşınmaz əmlak xidmətləri sektorunda <b>30 illik təcrübəyə malik şirkətlər qrupudur.</b>
        </p>
